...
import {ContactSection,HeadingWrapper,Heading,SubHeading,ContactInner,Form,FormGroup,InputText,ContactContentsBg,
    MessageTextarea,SubmitBtn,TextCenter,AddressWrapper,AddressCol,IconHolder,AddressIcon,TextHolder,CustomContainer,
    AddressText,ContactSpanErr,ContactSpanSuccess
} from './contact.style';
import {Row,Col} from "react-bootstrap";
import 'bootstrap/dist/css/bootstrap.min.css';
import { ContactUs } from '../../../pagedata/App';
                        ...
                        <Col md="12">
                            <HeadingWrapper>
                                ...
                                <ContactInner>
                                    <Form id="contactForm" method="post">
                                        <Row>
                                            ...
                                            <Col md="12">
                                                <FormGroup>
                                                    <MessageTextarea type="tel" placeholder="Message" name="contact_message" onChange={this.handleChange} value={this.state.contact_message}></MessageTextarea>
                                ...
                                <AddressWrapper>
                                    ...
                                    <Col md="6">
                                    { 
                                        ContactUs.AddressWrapper1.map((item,idx) => {
                                        return  <AddressCol>
                                                        <IconHolder>
                                        ...
                                        <Col md="6">
                                        { 
                                            ContactUs.AddressWrapper2.map((item,idx) => {
                                            return  <AddressCol>
                                                            <IconHolder>
                                                                <AddressIcon src={require("../../../assets/"+item.AddressIcon)} alt=""/>
                                                            </IconHolder>
