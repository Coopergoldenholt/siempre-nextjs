...
import {NewsletterSection,NewsletterInner,NewsletterForm,NewsletterInput,
    SubscribeSpanErr,SubscribeSpanSuccess,Form,FormGroup,SendIcon,
    NewsletterSubmit} from './subscribeletter.style'
import {SectionHeading} from '../Common/common.style';
import { SubscribeNewsLetter } from '../../../pagedata/Corporate';
                        ...
                        <Form id="subscribeForm" method="post" onSubmit={this.subscribeSubmit}>
                            <FormGroup>
                                <NewsletterForm>
                                    ...
                                    <NewsletterSubmit type="submit">Submit <SendIcon/></NewsletterSubmit>
                                </NewsletterForm>
                            </FormGroup>
