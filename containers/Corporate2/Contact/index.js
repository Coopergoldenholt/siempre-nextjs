...
import {ContactSection,ContactInner,ContactLeft,InputField,ContactSpanErr,ContactSpanSuccess,
    ...
    ContactRightImg,ContactRightTextHolder,ContactRightText,ContactRightHeading,ContactRow} from './contact.style';
import { ContactUs } from '../../../pagedata/Corporate2';
                ...
                <Container>
                    <ContactInner>
                        <ContactRow>
                            ...
                            <Col md="5">
                                <ContactRight>
                                        <ContactRightHeading>Contact Us</ContactRightHeading>
                                    {
