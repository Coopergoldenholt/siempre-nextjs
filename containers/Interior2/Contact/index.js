...
import {ContactSection,ContactInner,ContactRight,InputField,ContactSpanErr,
    ...
    Form,FormGroup,ContactLeftPara,ContactLeftHeading,ContactRow} from './contact.style';
                ...
                <Container>
                    <ContactInner>
                        <ContactRow>
                            <Col md="5">
                                <ContactLeft>
                                    <ContactLeftHeading>{ContactUs.SectionHeading}</ContactLeftHeading>
                                    <ContactLeftPara>{ContactUs.ContactRight.ContactRightPara}</ContactLeftPara>
                                </ContactLeft>
                            </Col>
                            <Col md="7">
                                <ContactRight>
