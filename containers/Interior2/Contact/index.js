...
import { ContactUs } from "../../../pagedata/Interior2";
				...
				<Container>
					<ContactInner>
						<ContactRow>
							<Col md="5">
								<ContactLeft>
									<ContactLeftHeading>Intrested?</ContactLeftHeading>
									<ContactLeftPara>
									...
									<ContactCard>
										...
										>
											<FormGroup>
												...
												></InputField>
												<ContactSpanErr id="err_contact_name">
											...
											<FormGroup>
												...
												></InputField>
												<ContactSpanErr id="err_contact_email">
											...
											<FormGroup>
												...
												></InputField>
												<ContactSpanErr id="err_contact_subject">
											...
											<FormGroup>
												...
												></TextArea>
												<ContactSpanErr id="err_contact_message">
													{this.state.errors.contact_message}
												</ContactSpanErr>
											</FormGroup>

											<SubmitBtn
												style={{ backgroundColor: "#855c52" }}
												type="submit"
											>
												Submit
											</SubmitBtn>
