...
import {ContactWrapper,ContactInner,ContactLeft,InputField,ContactSpanErr,ContactSpanSuccess,
    TextArea,SubmitBtn,ContactRight,ContactRightRow,ContactRightImgHolder,FormGroup,ContactHeadingWrapper,Heading,SubHeading,
    ContactRightImg,ContactRightTextHolder,ContactRightText,ContactRow} from './contact.style';
import { ContactUs } from '../../../pagedata/App2';
                    ...
                    <Row>
                        <Col md="12">
                            <ContactHeadingWrapper>
                                    <Heading>{ContactUs.SectionHeading}</Heading>
                                    <SubHeading>{ContactUs.SectionSubHeading}</SubHeading>
                            </ContactHeadingWrapper>
                        </Col>
                    </Row>
                        <ContactInner>
